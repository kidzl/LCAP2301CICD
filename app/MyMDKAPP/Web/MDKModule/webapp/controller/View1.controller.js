sap.ui.define([
	...
	return Controller.extend("DraftEnableTesting_MyMDKAPP.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("DraftEnableTesting_MyMDKAPP/mdkindex.html?" + queryString);
